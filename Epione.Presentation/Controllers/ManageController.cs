    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                PhoneNumber = await UserManager.GetPhoneNumberAsync(Int32.Parse(userId)),
                TwoFactor = await UserManager.GetTwoFactorEnabledAsync(Int32.Parse(userId)),
                Logins = await UserManager.GetLoginsAsync(Int32.Parse(userId)),
